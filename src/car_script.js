    ...
    document.getElementById('left').addEventListener('click', () => {
        if (document.getElementById('i1').style.display == 'none') {
            ...
            setTimeout(() => {
                ...
                window.id1 = document.querySelector('.active_img').id;
                document.getElementById(id1).classList.remove('active_img');
                document.getElementById(id1).style.display = 'none';
            }, 250);
            setTimeout(() => {
                let ids = document.getElementById(window.id1).previousElementSibling.id;
            ...
            setTimeout(() => {
                var ids = i1.parentNode.children[i1.parentNode.children.length - 1].id;
                var ids1 = ids.slice(1,);
                document.getElementById(`l${ids1}`).classList.add('active_dot');
    ...
    document.getElementById('right').addEventListener('click', () => {
        if (document.getElementById('i3').style.display == 'none') {
            ...
            setTimeout(() => {
                ...
                document.getElementById(window.id1).classList.remove('active_img');
                document.getElementById(window.id1).style.display = 'none';
            }, 250);
            setTimeout(() => {
                document.getElementById(window.id1).nextElementSibling.style.display = 'block';
                document.getElementById(window.id1).nextElementSibling.classList.add('slide4');
                document.getElementById(window.id1).nextElementSibling.classList.add('active_img');
            }, 250);
            setTimeout(() => {
